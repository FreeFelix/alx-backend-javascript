...
+ [x] 0. **Const or let?**<br/>[0-constants.js](0-constants.js) contains a script that meets the following requirements.
 ...
 1. Block Scope<br/>1-block-scoped.js contains a script that meets the following requirements.
...
export default function taskBlock(trueOrFalse) {
 ...
 2. Arrow functions<br/>2-arrow.js contains a script that meets the following requirements.
...
export default function getNeighborhoodsList() {
 ...
 3. Parameter defaults<br/>3-default-parameter.js contains a script that meets the following requirements.
...
export default function getSumOfHoods(initialNumber, expansion1989, expansion2019) {
 ...
 4. Rest parameter syntax for functions<br/>4-rest-parameter.js contains a script that meets the following requirements.
...
export default function returnHowManyArguments() {
 ...
 5. The wonders of spread syntax<br/>5-spread-operator.js contains a script that meets the following requirements.
...
export default function concatArrays(array1, array2, string) {
 ...
 6. Take advantage of template literals<br/>6-string-interpolation.js contains a script that meets the following requirements.
...
export default function getSanFranciscoDescription() {
 ...
 7. Object property value shorthand syntax<br/>7-getBudgetObject.js contains a script that meets the following requirements.
...
export default function getBudgetObject(income, gdp, capita) {
 ...
 8. No need to create empty objects before adding in properties<br/>8-getBudgetCurrentYear.js contains a script that meets the following requirements.
...
export default function getBudgetForCurrentYear(income, gdp, capita) {
 ...
 9. ES6 method properties<br/>9-getFullBudget.js contains a script that meets the following requirements.
...
export default function getFullBudgetObject(income, gdp, capita) {
 ...
 10. For...of Loops<br/>10-loops.js contains a script that meets the following requirements.
...
export default function appendToEachArrayValue(array, appendString) {
 ...
 11. Iterator<br/>11-createEmployeesObject.js contains a script that meets the following requirements.
...
Copy code
{
 ...
 12. Let's create a report object<br/>12-createReportObject.js contains a script that meets the following requirements.
...
The method property receives employeesList and returns the number of departments.
 13. Iterating through report objects<br/>100-createIteratorObject.js contains a script that meets the following requirements.
...
This function will return an iterator to go through every employee in every department.
 14. Iterate through object<br/>101-iterateThroughObject.js contains a script that meets the following requirements.
